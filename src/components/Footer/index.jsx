      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2  lg:grid-cols-4 gap-8">
          <div className="mb-8 md:mb-0">
            <h3
              className="text-lg font-bold mb-2 gilroyb"
              style={{ color: "rgba(255, 255, 255, 0.92)" }}
            >
              Swiggy
            </h3>
            <p className="text-sm ftcolor gilroy">
              &copy; 2024 Bundl Technologies Pvt. Ltd
            </p>
          </div>
          <div className="mb-8 md:mb-0">
            <h3
              className="text-lg font-bold mb-4 gilroyb"
              style={{ color: "rgba(255, 255, 255, 0.92)" }}
            >
              Company
            </h3>
          ...
          <div className="mb-8 md:mb-0">
            ...
            <h3
              className="text-lg font-bold mt-4 mb-2 gilroyb"
              style={{ color: "rgba(255, 255, 255, 0.92)" }}
            >
              Legal
            </h3>
