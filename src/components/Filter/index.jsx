    ...
    <div className="flex flex-wrap p-4 pt-8 space-x-4 space-y-2 items-center">
      <div className="relative mt-2">
        <button
          ...
          className="flex justify-center items-center gap-2 py-2 px-4 rounded-3xl font-semibold gilroy"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
          }}
        >
          Filter <img src="/filter.png" alt="" className="w-4 h-4 mt-0.5" />
        </button>
        {activeDropdown === "filter" && (
          <div className="absolute bg-white border mt-2 p-4 rounded shadow-lg z-10 w-40 h-96 overflow-y-auto custom-scrollbar">
            ...
            <button
              ...
              className="mt-2 w-full p-2 bg-blue-500 text-white rounded gilroy"
            >
              Apply
            </button>
          </div>
      ...
      <div className="relative">
        <button
          ...
          className="py-2 px-4 rounded-2xl font-semibold flex justify-center items-center gap-2 gilroy"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
          }}
      ...
      <div className="relative">
        <button
          onClick={() => toggleDropdown("fastDelivery")}
          className="py-2 px-4 rounded-2xl font-semibold flex justify-center items-center gap-2 gilroy"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
      ...
      <div className="relative">
        <button
          onClick={() => toggleDropdown("newOnSwiggy")}
          className="py-2 px-4 rounded-2xl font-semibold gilroy flex justify-center items-center gap-2"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
          }}
      ...
      <div className="relative">
        <button
          onClick={() => toggleDropdown("pureVeg")}
          className="py-2 px-4 rounded-2xl font-semibold gilroy flex justify-center items-center gap-2"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
      ...
      <div className="relative">
        <button
          onClick={() => toggleDropdown("lessThan300")}
          className="py-2 px-4 rounded-2xl font-semibold gilroy flex justify-center items-center gap-2"
          style={{
            border: "1px solid rgba(2, 6, 12, 0.15)",
            color: "rgba(2, 6, 12, 0.75)",
